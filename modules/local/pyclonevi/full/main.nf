...
process PYCLONEVI_FULL_2PASS {
    ...
    output:
        tuple val(meta), path("*_PyCloneVI_OUT_2PASS.tsv"), emit: tsv
        path "versions.yml"                         , emit: versions
    ...
    pyclone-vi write-results-file \\
        -i ${prefix}_PC_OUT.h5 \\
        -o ${prefix}_PyCloneVI_OUT_2PASS.tsv \\
        ${args2}
    ...
    def prefix = task.ext.prefix ?: "${meta_map.id}"
    """
    touch ${prefix}_PyCloneVI_OUT_2PASS.tsv
